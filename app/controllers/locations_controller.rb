class LocationsController < ApplicationController
  ...
  def show
    ...
    @buses.select! do |bus|
      is_nearby?(@location.latitude, @location.longitude, bus["LATITUDE"], bus["LONGITUDE"], @location.max_distance)
    end
  ...
  private
    ...
    def location_params
      params.require(:location).permit(:street_address, :city, :latitude, :longitude, :max_distance)
    end
end
